...
What is one small thing you \emph{can} control right now?\index{practices}\index{exercises}\index{action steps}
...
\textbf{What's one thing you can celebrate about yourself today?}\index{exercises}\index{action steps}\index{practices}
